                            ...
                            document.getElementById('timeline').addEventListener(
                                ...
                                function (e) {
                                    ...
                                    for (i = 0; i < Highcharts.charts.length; i = i + 1) {
                                        ...
                                        if (currentID === "geomap1" || currentID === "timeline1" || currentID === "radar"){
                                            continue;
                                        }
                                        ...
                                        if (point) {
                                            ...
                                            histogram.setTitle({'text': point.id + ' Age Group Suicide Rate','verticalAlign':'top'});
                            ...
                            */
                            ...
                            if (i <=parseInt(year)){
                                currentData.push(parseFloat(dataset1[i]['suicide_rate']));
                            }
                            else{
                            ...
                            success: function(activity){
                                ...
                                dataset1 = activity[0];
                                timeline_data = [];
                                timelineid = Object.keys(dataset1);
                                for (i =0;i<timelineid.length;i++){
                                    currentYear = dataset1[timelineid[i]];
